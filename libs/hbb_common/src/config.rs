...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("LabDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["labdesk.labchecap.com.br"];
pub const RS_PUB_KEY: &str = "vzytYsUi22rZS+0FH7PeWyFQc+BZIsTlYkBfhxE0BPA=";
